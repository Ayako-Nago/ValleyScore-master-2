...
class GameTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "reuseIdentifier", for: indexPath) as! TeamTableViewCell
        
        cell.team0.text = gameArray[indexPath.row].team0?.team0Name
        cell.team1.text = gameArray[indexPath.row].team1?.team1Name
    ...
    override func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        try! realm.write {
            realm.delete(self.gameArray[indexPath.row])
        }
